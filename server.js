...
app.get('/register', (req, res) => res.sendFile(path.join(process.cwd(), 'views', 'register.html')));
app.get('/login', (req, res) => res.sendFile(path.join(process.cwd(), 'views', 'login.html')));
app.get('/admin', (req, res) => res.sendFile(path.join(process.cwd(), 'views', 'admin.html')));
